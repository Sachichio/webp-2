...
<div class="container">
    ...
    <div class="title-container">
        <h1 class="title">Manajemen Guru</h1>
    </div>

    <!-- Block 2: Table -->
    <div class="table-container">
        <div class="table-header">
            <a href="{{ route('admin.createGuru') }}" class="btn btn-primary">+ Add</a>
        ...
        <table class="table table-striped table-bordered" id="guruTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if ($guru->pelajaran->isEmpty())
                            <span class="text-muted">Belum Ada Pelajaran</span>
                        @else
                            @foreach($guru->pelajaran as $pel)
                                {{ $pel->nama_pelajaran }}<br>
                            @endforeach
                        @endif
                    </td>
                    <td>
                        <div class="btn-group">
                            <a href="{{ route('admin.editGuru', $guru->id) }}" class="btn-secondary-edit" style="display: flex; align-items: center;">
                                <img src="{{ asset('backend/icons/edit.svg') }}" alt="Edit" style="width: 16px; height: 16px; vertical-align: middle; margin-right: 5px;">
                                Edit
                            </a>
                            <form action="{{ route('admin.deleteGuru', $guru->id) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
        ...
        <div class="pagination-controls">
            <div class="pagination-info">
                <span id="entriesInfo">Showing 1 to 5 of {{ $gurus->count() }} entries</span>
            </div>
