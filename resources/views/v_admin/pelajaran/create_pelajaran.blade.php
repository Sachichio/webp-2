...
<div class="container">
    ...
    <div class="table-container">
        <form action="{{ route('admin.storePelajaran') }}" method="POST" class="form-container">
            @csrf

            <div class="form-group">
                <label for="nama_pelajaran" class="form-label">Nama Mata Pelajaran:</label><small class="form-text text-muted">(Otomatis + kelas {jenjang})</small>
                <input type="text" name="nama_pelajaran" id="nama_pelajaran" class="form-input" value="{{ old('nama_pelajaran') }}" required>
