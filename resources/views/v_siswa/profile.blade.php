        ...
        <form action="{{ route('siswa.profile.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="profile-wrapper">
                <div class="profile-left">
                    <div class="foto-preview-container">
                        ...
                        <img src="{{ file_exists(public_path('uploads/profile/siswa/' . Auth::user()->username . '/' . Auth::user()->foto)) 
                            ? asset('uploads/profile/siswa/' . Auth::user()->username . '/' . Auth::user()->foto) . '?timestamp=' . time() 
                            : asset('uploads/profile/default.jpg') }}" 
                            alt="Siswa Profile Picture" class="foto-preview">
                ...
                <div class="profile-right">
                    ...
                    <div class="form-group">
                        <label>No. HP</label>
                        <input type="text" name="hp" value="{{ old('hp', $siswa->hp) }}" class="form-control @error('hp') is-invalid @enderror">
                        @error('hp')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
...
<script>
    function deletePhoto() {
        if (confirm('Apakah Anda yakin ingin menghapus foto ini?')) {
            fetch("{{ route('siswa.profile.destroyPhoto') }}", {
                method: 'DELETE',
                headers: {
